...
#
nvprof -m sm_efficiency ./sobel_gpu 1 32
nvprof -m sm_efficiency ./sobel_gpu 1 64
nvprof -m sm_efficiency ./sobel_gpu 1 128
nvprof -m sm_efficiency ./sobel_gpu 1 256
nvprof -m sm_efficiency ./sobel_gpu 1 512
nvprof -m sm_efficiency ./sobel_gpu 1 1024
